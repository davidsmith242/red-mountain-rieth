        ...
        <v-list two-line>
          <v-list-item>
            ...
            <v-list-item-content>
              ...
              <v-list-item-subtitle>Verwendungszweck: Du und dein Körper</v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
            ...
            <v-list-item-icon>
              <v-icon color="indigo">
                ...
                <!-- <span style="color:indigo">
                  <font-awesome-icon style="font-size: 12px, color: indigo;" icon="fa-brands fa-paypal" />
                </span> -->
              </v-icon>
            </v-list-item-icon>
...
<script>
  export default {
    ...
    components: {
      Kontakt: () => import('@/dialogs/Kontakt')
    },
    data () {
      return {
        dialog: false,
        caption: this.title || 'Spendeninformation',
      };
    },
  }
</script>
